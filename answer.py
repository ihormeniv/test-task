...
#Decorator is a function that takes another function (decorated function) as an input and it can execute extra logic before/after trigering decorated function
...
#4
'''Create micro library that allows users to work with notes about books authors.
Note should contain author_name, note, rating (rating - is 0 - 1 rating of the author)
